	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/roles", "/produtos/dto", "/categorias/dto", "/swagger-ui/**", "/v3/api-docs/**").permitAll() //define as rotas publicas/abertas
                    .requestMatchers("/enderecos", "/pedidos", "/clientes", "/produtos", "/itemPedidos").hasAnyRole("USER", "ADMIN") // autoriza o acesso a rotas por perfil
                    .requestMatchers("/categorias/**", "/clientes/**", "/enderecos/**", "/itemPedidos/**", "/pedidos/**", "/produtos/**").hasRole("ADMIN") //autoriza o acesso a rotas por perfis
