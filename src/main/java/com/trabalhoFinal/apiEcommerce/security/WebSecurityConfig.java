...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/roles", "/produtos/dto", "/categorias/dto", "/swagger-ui/**", "/v3/api-docs/**", "/upload/**",  "/produtos/**", "/categorias/**", "/clientes/**").permitAll() //define as rotas publicas/abertas
                    .requestMatchers("/enderecos/**", "/itemPedidos/**", "/pedidos/**", "/users/**").hasAnyRole("ADMIN", "MODERATOR", "USER") //autoriza o acesso a rotas por perfis
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "https://eldritchcards-gilt.vercel.app"));
