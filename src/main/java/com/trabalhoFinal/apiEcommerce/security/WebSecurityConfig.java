	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/roles", "/produtos/dto", "/categorias/dto", "/swagger-ui/**", "/v3/api-docs/**", "/upload/**",  "/produtos/**").permitAll() //define as rotas publicas/abertas
                    .requestMatchers("/pedidos/user/**").hasRole("USER") // autoriza o acesso a rotas por perfil
                    .requestMatchers("/categorias/**", "/clientes/**", "/enderecos/**", "/itemPedidos/**", "/pedidos/**", "/users/**").hasAnyRole("ADMIN", "MODERATOR") //autoriza o acesso a rotas por perfis
